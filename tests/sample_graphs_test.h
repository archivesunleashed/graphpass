extern igraph_t star_graph; // Graph contains a star, a triad and a bridge node.
extern igraph_t star_digraph; // Graph contains a star, a triad and a bridge node.

int createUndirectedGraph () {
...
int createDirectedGraph() {
  ...
  igraph_vector_destroy(&star_digraph_vector);
  return 0;
}
